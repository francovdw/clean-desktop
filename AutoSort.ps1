...
$exclude = "AutoSort.ps1","NetAdapter_v1.ps1","PS WorkShop","LPCMID002.ink","PS Online.ps1","PSW","Scripting","YD-v1","Telkom LTE","AutoSort-P.ps1","IPBH","RDG.rdp","Boardroom Bot v2.html","Support","PSOnline.ps1","WIP","CloudShare.ink"
